...
HD_PWD='/media/nisitha/My_Passport/MOODLE/Vivado_projects/SNN_project/snn_implementation/snn_implementation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snn_rgb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snn_rgb.tcl
